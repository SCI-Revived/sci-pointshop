...
PS.Items = {
	...
	---------------- Entities ----------------
	["m9k_ammo_40mm_single"] = {
		Name = "Single 40mm Grenade",
		BasePrice = 35,
		Type = PS.ITEM_TYPE_ENTITY,
		Icon = "vgui/entities/m9k_ammo_40mm_single",
		Description = "Ammo for M9K Grenade Launchers",
	},
	["m9k_ammo_40mm"] = {
		Name = "40mm Grenade Box (x64)",
		BasePrice = 2000,
		Type = PS.ITEM_TYPE_ENTITY,
		Icon = "vgui/entities/m9k_ammo_40mm",
		Description = "x64 Ammo for M9K Grenade Launchers",
	},
	["m9k_ammo_c4"] = {
		Name = "Timed C4 x8",
		BasePrice = 1250,
		Type = PS.ITEM_TYPE_ENTITY,
		Icon = "vgui/entities/m9k_ammo_c4",
		Description = "8 timed C4s.",
	},
	["m9k_ammo_proxmines"] = {
		Name = "Proximity Mines x24",
		BasePrice = 2500,
		Type = PS.ITEM_TYPE_ENTITY,
		Icon = "vgui/entities/m9k_ammo_proxmines",
		Description = "24 Proximity Mines.",
	},
	...
	["m9k_minigun"] = {
		...
		Icon = "vgui/entities/m9k_minigun",
	...
	["m9k_barret_m82"] = {
		...
		BasePrice = 650,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_barret_m82",
		Description = "High damage, semi autoamtic Anti-materiel rifle.",
	},
	["m9k_davy_crockett"] = {
		Name = "Davy Crockett",
		BasePrice = 75000,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_davy_crockett",
	...
	["m9k_matador"] = {
		...
		BasePrice = 1000,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_matador",
	...
	["m9k_milkormgl"] = {
		...
		BasePrice = 1750,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_milkormgl",
	...
	["m9k_nerve_gas"] = {
		...
		BasePrice = 750,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_nerve_gas",
	...
	["m9k_nitro"] = {
		...
		BasePrice = 200,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_nitro",
		Description = "Hand thrown container that creates a large explosion upon breaking.",
	},
	["m9k_orbital_strike"] = {
		Name = "Orbital Strike Marker",
		BasePrice = 7500,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_orbital_strike",
	...
	["m9k_proxy_mine"] = {
		...
		BasePrice = 125,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_proxy_mine",
	...
	["m9k_suicide_bomb"] = {
		...
		BasePrice = 200,
		Type = PS.ITEM_TYPE_WEAPON,
		Icon = "vgui/entities/m9k_suicide_bomb",
		Description = "Creates a large explosion when triggered.",
	},
